...
export const appRouter = [
    {
        ...
        component: Main,
        children: [
            { path: 'index', title: '用户管理', name: 'accesstest_index', access: 0, component: () => import('@/views/access/access-test.vue') }
        ]
    },
    {
        path: '/tables',
    ...
    // },
    {
        ...
        component: Main,
        children: [
            { path: 'artical-publish', title: '文件模块', name: 'artical-publish', icon: 'compose', component: () => import('@/views/form/article-publish/article-publish.vue') },
